...
const GEMINI_API_KEY = process.env.GEMINI_API_KEY; // Updated Variable Name
const SLACK_BOT_TOKEN = process.env.SLACK_BOT_TOKEN;

// 1. Safety Check
if (!GEMINI_API_KEY || !SLACK_BOT_TOKEN) {
  console.error("❌ ERROR: Missing GEMINI_API_KEY or SLACK_BOT_TOKEN in Railway variables.");
}
